...
@ApiModel("增加生产单据请求封装类")
@Data
public class AddProductionBillRequest implements Serializable {
    ...
    /**
     * 职员 id（业务员在生产任务单中称为计划员、在领料环节称为领料人、在退料环节称为退料人、在入库环节称为交货人、在退库环节称为收货人）
     */
    @ApiModelProperty("职员 id（业务员在生产任务单中称为计划员、在领料环节称为领料人、在退料环节称为退料人、在入库环节称为交货人、在退库环节称为收货人）")
    private Long employeeId;

    /**
     * 部门 id（部门在生产任务单中称为生产车间、在领料环节称为领料部门、在退料环节称为退料部门、在入库环节称为交货部门、在退库环节收货部门）
     */
    @ApiModelProperty("部门 id（部门在生产任务单中称为生产车间、在领料环节称为领料部门、在退料环节称为退料部门、在入库环节称为交货部门、在退库环节收货部门）")
    ...
    /**
     * 生产单据退还原因（退料原因或者是退库原因，在领料环节和退库环节中可以输入）
     */
     ...
     * 增加生产单据商品及数量请求列表
     */
    @ApiModelProperty("增加生产单据商品及数量请求列表")
    private List<AddProductionProductNumRequest> addProductionProductNumRequestList;
