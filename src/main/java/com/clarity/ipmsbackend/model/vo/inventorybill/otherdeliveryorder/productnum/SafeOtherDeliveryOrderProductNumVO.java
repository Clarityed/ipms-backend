package com.clarity.ipmsbackend.model.vo.inventorybill.otherdeliveryorder.productnum;
...
@ApiModel("安全其他出库单商品响应封装类")
@Data
public class SafeOtherDeliveryOrderProductNumVO implements Serializable {
