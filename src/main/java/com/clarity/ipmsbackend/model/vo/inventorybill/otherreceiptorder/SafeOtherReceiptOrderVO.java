package com.clarity.ipmsbackend.model.vo.inventorybill.otherreceiptorder;
...
@ApiModel("安全其他入库单响应封装类")
@Data
public class SafeOtherReceiptOrderVO implements Serializable {
    ...
    private String supplierLinkmanAdminDivision;

    /**
     * 联系人详细地址
     */
    @ApiModelProperty("联系人详细地址")
    private String supplierLinkmanDetailAddress;
    ...
    private List<SafeOtherReceiptOrderProductNumVO> safeOtherReceiptOrderProductNumVOList;
